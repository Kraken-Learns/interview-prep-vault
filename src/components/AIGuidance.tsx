...
const AIGuidance: React.FC<AIGuidanceProps> = ({ problem, userCode, language, onClose }) => {
    ...
    return (
        <div className="fixed inset-y-0 right-0 w-full md:w-[500px] bg-white shadow-2xl z-40 flex flex-col animate-in slide-in-from-right duration-300 border-l border-slate-200">
            {/* Header */}
